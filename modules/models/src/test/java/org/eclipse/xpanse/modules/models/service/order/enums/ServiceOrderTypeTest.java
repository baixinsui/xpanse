...
class ServiceOrderTypeTest {
    ...
    void testGetByValue() {
        ...
        assertThat(ServiceOrderType.getByValue("lock change")).isEqualTo(
                ServiceOrderType.LOCK_CHANGE);
        assertThat(ServiceOrderType.getByValue("Config Change")).isEqualTo(
    ...
    void testToValue() {
        ...
        assertThat(ServiceOrderType.LOCK_CHANGE.toValue()).isEqualTo("lock change");
        assertThat(ServiceOrderType.CONFIG_CHANGE.toValue()).isEqualTo("config change");
